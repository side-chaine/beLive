---
description: beLive Gateway & Auth Scout. Читает auth-system docs, анализирует Workers и AI flow.
mode: all
...
## Модель
**T0: Hy3 Free** — gateway-код компактный (~500 строк), Hy3 справляется.
