      ...
      <div ref={gridRef} className="bl-catalog-grid" style={{ flex: 1, minHeight: 0, padding: '12px 16px 16px' }}>
        ...
        <div className="bl-catalog-col" style={colBase}>
          ...
          <div style={{ display:catalogTab==='catalog'?'flex':'none', flexDirection:'column', flex:1, minHeight:0 }}>
            <input value={searchQuery} onChange={e=>setSearchQuery(e.target.value)} placeholder="Найти трек..." style={{ width:'100%', background:'rgba(0,0,0,0.3)', color:'#fff', border:`1px solid ${T.border2}`, borderRadius:T.r, padding:'8px 12px', fontSize:12, boxSizing:'border-box', outline:'none', marginBottom:8, flexShrink:0 }} />
