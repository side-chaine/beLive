// ============================================================
// run-gate2-pc-diagnostics-v6.32.3.console.js
...
;(async () => {
  ...
  const SOURCE_PATH = 'src/audio/engine-v3/diagnostics/run-gate2-pc-diagnostics-v6.32.3.console.js';
  ...
  const out = {
    metadata: {
      ...
      node: IS_NODE ? process.version : null,
  ...
  try {
    if (!IS_NODE) throw new Error('browser mode not executed (MAND 202: no-browser GO; run in node-headless)');
