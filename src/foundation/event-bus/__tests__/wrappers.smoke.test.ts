...
// Smoke-тесты для EventBus-каналов (экс-bridges, обёртки; Волна C)
describe('Bridge smoke tests (Facade must keep working)', () => {

  it('lyrics-events: track-loaded triggers active-line-changed', () => {
  ...
  it('markers-events: sections-updated delivers payload', () => {
  ...
  it('loop-events: before-track-change triggers cleanup', () => {
    let called = false
