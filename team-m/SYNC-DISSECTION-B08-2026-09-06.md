...
| **Vitest-канон** | 812/68 (зона не трогала) | замер не делала — head-канон реестра; живого прогона зоны нет |
...
**Что НЕ ПРОВЕРЕНО:** живой UX-прогон редактора руками (смоук не делался — только код-разбор); vitest зоны отдельно не гонялся (канон общий 812/68); поведение на PHONE-размерах (зона PHONE-аудита); поведение LRC-пикера при 0 версий в живой сети.
