...
- `docs/archive/superseded/product-protocol-v2.1.md (архив)`, `docs/SYNC-PROTOCOL.md`, `team-m/SHARED-REGISTRY.md §0 (MAC-PC-BRIDGE-SPEC → historical-redirect)` — протоколы.
